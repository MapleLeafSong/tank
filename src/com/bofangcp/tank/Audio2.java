...
public class Audio2 extends Thread{
    ...
    public Audio2(String fileName) {
        try {
            audioInputStream = AudioSystem.getAudioInputStream(Audio2.class.getClassLoader().getResource(fileName));
    ...
    public static void main(String[] args) {
        ...
        Audio2 a = new Audio2("audio/war1.wav");
        a.loop();
